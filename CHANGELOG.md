...
[2.0.0,A2]: https://gitlab.com/jtholmi/wit_io/-/blob/v1.4.0.1/EXAMPLE%20cases/
...
[2.0.0,A6]: https://gitlab.com/jtholmi/wit_io/-/blob/v2.0.0/+WITio/+fun/href_dir.m
...
- Remove unintentional dependency on `MATLAB R2013b` or newer by replacing occurences of `strjoin` with new [`WITio.fun.indep.mystrjoin`][2.0.0,F4].
- Improve non-interactive mode by new [`WITio.tbx.edit`][2.0.0,F5] and [`WITio.tbx.verbose`][2.0.0,F6] functions, which make running the demo cases faster for testing purposes.
...
[2.0.0,F4]: https://gitlab.com/jtholmi/wit_io/-/blob/v2.0.0/+WITio/+fun/+indep/mystrjoin.m
[2.0.0,F5]: https://gitlab.com/jtholmi/wit_io/-/blob/v2.0.0/+WITio/+tbx/edit.m
[2.0.0,F6]: https://gitlab.com/jtholmi/wit_io/-/blob/v2.0.0/+WITio/+tbx/verbose.m

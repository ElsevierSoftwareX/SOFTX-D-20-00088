...
function obj = new_Transformation_Space(O_wit),
    ...
    Tag_Extra = wit('TDSpaceTransformation', [ ...
        ...
        wit('LineStart_D', double([0 0 0])) ... % (NOT IN ALL LEGACY VERSIONS) % 1st point == WorldOrigin<ViewPort3D
        wit('LineStart', single([0 0 0])) ... % 1st point
        wit('LineStop_D', double([1 1 1])) ... % (NOT IN ALL LEGACY VERSIONS) % N+1'th point

...
function format = DataTree_format_TDSpaceTransformation(Version_or_obj)
    ...
    subformat_TDSpaceTransformation_v5_v6_v7 = ... % Excluding the Version-tag
    	{ ...
    ...
    format_TDSpaceTransformation_v5_v6_v7 = ...
        [wid.DataTree_format_TData(Version_or_obj); ...
        wid.DataTree_format_TDTransformation(Version_or_obj); ...
        {'TDSpaceTransformation' true subformat_TDSpaceTransformation_v5_v6_v7}];
    
    format = format_TDSpaceTransformation_v5_v6_v7;
end

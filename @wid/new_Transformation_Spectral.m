...
function obj = new_Transformation_Spectral(C_wit)
    ...
    Tag_Extra = wit('TDSpectralTransformation', [ ...
        ...
        wit('FreePolynomOrder', double(-1)) ... % Unimplemented
        wit('FreePolynomStartBin', double(0)) ... % Unimplemented
        wit('FreePolynomStopBin', double(0)) ... % Unimplemented
        wit('FreePolynom', double([])) ... % Unimplemented
        ]);

...
function format = DataTree_format_TDSpectralInterpretation(Version_or_obj)
    ...
    subformat_TDSpectralInterpretation_v5_v6_v7 = ... % Excluding the Version-tag
    	{ ...
    ...
    format_TDSpectralInterpretation_v5_v6_v7 = ...
        [wid.DataTree_format_TData(Version_or_obj); ...
        wid.DataTree_format_TDInterpretation(Version_or_obj); ...
        {'TDSpectralInterpretation' true subformat_TDSpectralInterpretation_v5_v6_v7}];
    
    format = format_TDSpectralInterpretation_v5_v6_v7;
end

...
function [unique_wid_Types, B_diversity_matrix, versions, files] = dev_get_unique_wid_Types(files),
    if nargin == 0, files = dev_get_dir_files_recursively(); end
    ...
    for ii = 1:numel(files),
        ...
        Tag_Data = O_wit.regexp('^NumberOfData<Data(<[^<]*)*$', true).Parent;

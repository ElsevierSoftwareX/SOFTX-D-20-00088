...
% wit.io.wid.plot_position_Image_helper.m, wit.io.wid.plot_position_Line_helper.m and
% wit.io.wid.plot_position_Point_helper.m.
function h_position = plot_position(obj, FigAxNeither, varargin),
    ...
    B_valid = cellfun(@(x) isa(x, 'wit.io.wid'), varargin); % Test if wid

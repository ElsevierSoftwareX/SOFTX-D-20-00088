...
function obj = new_Interpretation_Spectral(O_wit),
    ...
    Tag_Extra = wit.io.wit('TDSpectralInterpretation', [ ...
        wit.io.wit('Version', int32(0)) ...
        wit.io.wit('ExcitationWaveLength', double(NaN)) ...
        ]);
    
    Tag_DataClassName = wit.io.wit('DataClassName 0', 'TDSpectralInterpretation');

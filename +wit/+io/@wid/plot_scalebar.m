...
% Default scalebar plotter function 'wit.io.wid.plot_scalebar_helper' accepts the
...
function h_scalebar = plot_scalebar(obj, FigAxNeither, varargin),
    ...
    [datas, varargin] = wit.io.parse.varargin_dashed_str_datas('markScalebarFun', varargin, -1);
    markScalebar = @wit.io.wid.plot_scalebar_helper;

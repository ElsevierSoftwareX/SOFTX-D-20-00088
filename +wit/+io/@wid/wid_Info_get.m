...
function out = wid_Info_get(obj),
    ...
    SpaceTransformation = wit.io.wid.empty;
    SecondaryTransformation = wit.io.wid.empty; % v7 (only known case: Time<TDGraph, where SpaceTransformation and SecondaryTransformation are related to time (a vector) and space (a single point) in WITec Project FIVE, respectively.)
    GraphTransformation = wit.io.wid.empty;
    GraphInterpretation = wit.io.wid.empty;
    DataInterpretation = wit.io.wid.empty;
    ...
    out.XInterpretation = wit.io.wid.empty;
    ...
    out.YInterpretation = wit.io.wid.empty;
    ...
    out.ZInterpretation = wit.io.wid.empty;
    ...
    out.SecondaryXInterpretation = wit.io.wid.empty;
    ...
    out.SecondaryYInterpretation = wit.io.wid.empty;
    ...
    out.SecondaryZInterpretation = wit.io.wid.empty;
end

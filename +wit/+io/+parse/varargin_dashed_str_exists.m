...
function varargout = varargin_dashed_str_exists(varargin),
    if nargout == 1,
        varargout{1} = wit.io.parse.varargin_dashed_str_exists_and_datas(varargin{:});
    elseif nargout > 1,
        [varargout{1}, ~, varargout{2:nargout}] = wit.io.parse.varargin_dashed_str_exists_and_datas(varargin{:});
    end
end

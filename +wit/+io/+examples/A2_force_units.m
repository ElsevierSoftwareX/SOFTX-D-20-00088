...
h = wit.io.misc.msgbox({'{\bf\fontsize{12}\color{magenta}EXAMPLE CASE A2:}' ...
...
%-------------------------------------------------------------------------%
h = wit.io.misc.msgbox({'{\bf\fontsize{12}{\color{magenta}(A2)} The imported content units (DataUnit, SpaceUnit, SpectralUnit and ' ...
...
'' ...
'{\bf\fontname{Courier}[...] = wit.io.read(..., ''-DataUnit'', ''Counts'', ''-SpaceUnit'', ' ...
'''um'', ...' ...
...
'' ...
'{\bf\fontsize{12}{\color{magenta}(A2 iv.)} temporarily using wit.io.wip.interpret (or easier wid-class ' ...
...
% search string.
[O_wid, O_wip, O_wid_HtmlNames] = wit.io.read(file, '-all', ...

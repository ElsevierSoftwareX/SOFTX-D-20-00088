...
h = wit.io.misc.msgbox({'{\bf\fontsize{12}\color{magenta}EXAMPLE CASE C:}' ...
...
%-------------------------------------------------------------------------%
h = wit.io.misc.msgbox({'{\bf\fontsize{12}{\color{magenta}(C i.)} Recalibrating the Rayleigh-peak ' ...
'to zero position:}' ...
'' ...
...
%-------------------------------------------------------------------------%
h = wit.io.misc.msgbox({'{\bf\fontsize{12}{\color{magenta}(C ii.)} Lorentzians are fitted to the D-, ' ...
'G- and 2D-peaks.}' ...
'' ...
...
%-------------------------------------------------------------------------%
h = wit.io.misc.msgbox({'{\bf\fontsize{12}{\color{magenta}(C iv.)} Histograms of the previously cleaned intensity ratios, ' ...

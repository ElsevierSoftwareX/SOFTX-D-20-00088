...
h = wit.io.misc.msgbox({'{\bf\fontsize{12}\color{magenta}EXAMPLE CASE B1:}' ...
...
%-------------------------------------------------------------------------%
[O_wid, O_wip, O_wid_HtmlNames] = wit.io.read(file, '-all', '-SpectralUnit', 'rel. 1/cm'); % Load all the file plottable content and force SpectralUnit to Raman shift
...
%-------------------------------------------------------------------------%
h = wit.io.misc.msgbox({'{\bf\fontsize{12}{\color{magenta}(B1 i.)} Apply filters on the Raman D-, ' ...
'G- and 2D-peaks:}' ...
'' ...
...
%-------------------------------------------------------------------------%
h = wit.io.misc.msgbox({'{\bf\fontsize{12}{\color{magenta}(B1 ii.)} Apply lineshape-fitting filters ' ...

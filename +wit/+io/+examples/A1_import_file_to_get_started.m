...
%-------------------------------------------------------------------------%
wit_io_msgbox({'{\bf\fontsize{12}{\color{magenta}(A1 i.)} Load and browse file contents in a GUI by executing:}' ...
    '' ...
...
%-------------------------------------------------------------------------%
h = wit_io_msgbox({'{\bf\fontsize{12}{\color{magenta}(A1 ii.)} OR, load all file contents without GUI by executing:}' ...
    '' ...

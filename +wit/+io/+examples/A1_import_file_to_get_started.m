...
h = wit.io.misc.msgbox({'{\bf\fontsize{12}\color{magenta}EXAMPLE CASE A1:}' ...
...
%-------------------------------------------------------------------------%
wit.io.misc.msgbox({'{\bf\fontsize{12}{\color{magenta}(A1 i.)} Load and browse file contents in a ' ...
'GUI by executing:}' ...
'' ...

...
h = wit.io.misc.msgbox({'{\bf\fontsize{12}\color{magenta}EXAMPLE CASE D:}' ...
'{\bf\fontsize{12}SPECTRAL STITCHING}' ...
'' ...
'\bullet If unfamiliar with ''wit\_io'', then go through the previous ' ...
...
[O_wid, O_wip, O_wid_HtmlNames] = wit.io.read(file, '-all', '-Manager', '--Type', 'TDGraph', '-SpectralUnit', 'nm');
%-------------------------------------------------------------------------%



%-------------------------------------------------------------------------%
h = wit.io.misc.msgbox({'{\bf\fontsize{12}{\color{magenta}(D)} Spectral stitching the measured ' ...
...
%-------------------------------------------------------------------------%
[h,b] = wit.io.misc.msgbox({'{\bf\fontsize{12}Spectral stitching has completed:}' ...
'' ...

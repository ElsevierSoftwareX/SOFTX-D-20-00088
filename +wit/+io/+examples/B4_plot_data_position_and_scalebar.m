...
h = wit.io.misc.msgbox({'{\bf\fontsize{12}\color{magenta}EXAMPLE CASE B4:}' ...
...
%-------------------------------------------------------------------------%
[O_wid, O_wip, O_wid_HtmlNames] = wit.io.read(file, '-all'); % Load all the file plottable content
...
%-------------------------------------------------------------------------%
[h,b] = wit.io.misc.msgbox({'{\bf\fontsize{12}{\color{magenta}(B4)} Show position of objects on each ' ...

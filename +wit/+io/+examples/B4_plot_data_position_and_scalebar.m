...
%-------------------------------------------------------------------------%
[O_wid, O_wip, O_wid_HtmlNames] = wit.io.wip.read(file, '-all'); % Load all the file plottable content
...
h = wit_io_msgbox({'{\bf\fontsize{12}{\color{magenta}(B4)} Show position of objects on each other and display scalebar:}' ...
    ...
    '' ...
    '\bullet Any Image wid object plotting can be accompanied with {\bf\fontname{Courier}''-position''} and/or {\bf\fontname{Courier}''-scalebar''} options.' ...
    '' ...

...
[O_wid, O_wip, O_wid_HtmlNames] = wit.io.wip.read('-ifall', '-SpectralUnit', SpectralUnit, '--Manager', ...
...
for ii = 1:numel(O_wid),
    ...
    [Data_range, Graph_range] = wit.io.wid.crop_Graph_with_bg_helper(new_Data, O_wid_new.Info.Graph, bounds, 0, 0);

...
%     cHeight = [cumsum(Height(2:end), 'reverse') 0];
    ...
    function update(varargin),
        ...
        set(0, 'DefaultFigureColormap', wit.io.lib.perceptually_uniform_colormap(C_options{currentValue})); % Set new default! Backward compatible!
        set(Fig, 'Colormap', 'default'); % Reset to new default! Backward compatible!
%         set(Fig, 'Colormap', wit.io.lib.perceptually_uniform_colormap(C_options{currentValue}));
%         colormap(Ax, wit.io.lib.perceptually_uniform_colormap(C_options{currentValue}));
    end
end

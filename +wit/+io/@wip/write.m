...
% to the underlying writing function, i.e. wit.io.compress.m. See its
...
function write(obj, varargin),
    ...
    function OnWriteCompress_helper(obj, File),
        wit.io.compress(File, File_uncompressed, obj.bwrite(), '-ProgressBar', Params{:}); % Compress binary as *.zip/*.zst file
    end
end

...
% [N_read, buffer] = java_class_method_call('java.io.InputStream', 'read', jFIS, buffer, int32(0), int32(numel(buffer)); % This indirect call updates buffer but direct call to N_read = jFIS.read(buffer, 0, numel(buffer)); will not.

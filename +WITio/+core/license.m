...
% preference, execute WITio.core.pref.rm('license_dialog').
function license = license(),
    ...
    value = WITio.core.pref.get('license_dialog');
    if ~islogical(value) || numel(value) ~= 1 || value ~= false,
        WITio.core.pref.set('license_dialog', 'ask');
    end
    ...
    if strcmp(WITio.core.pref.get('license_dialog'), 'ask'),
        WITio.core.pref.set('license_dialog', true);
    else,
        WITio.core.pref.set('license_dialog', false);
    end
end

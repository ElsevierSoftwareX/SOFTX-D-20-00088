...
% WITio.core.wid.plot_position_Image_helper.m, WITio.core.wid.plot_position_Line_helper.m and
% WITio.core.wid.plot_position_Point_helper.m.
function h_position = plot_position(obj, FigAxNeither, varargin),
    ...
    markImage = @WITio.core.wid.plot_position_Image_helper;
    ...
    markLine = @WITio.core.wid.plot_position_Line_helper;
    ...
    markPoint = @WITio.core.wid.plot_position_Point_helper;
    ...
    B_valid = cellfun(@(x) isa(x, 'WITio.core.wid'), varargin); % Test if wid

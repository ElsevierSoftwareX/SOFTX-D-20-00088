...
function out = wid_Info_get(obj),
    ...
    SpaceTransformation = WITio.core.wid.empty;
    SecondaryTransformation = WITio.core.wid.empty; % v7 (only known case: Time<TDGraph, where SpaceTransformation and SecondaryTransformation are related to time (a vector) and space (a single point) in WITec Project FIVE, respectively.)
    GraphTransformation = WITio.core.wid.empty;
    GraphInterpretation = WITio.core.wid.empty;
    DataInterpretation = WITio.core.wid.empty;
    ...
    [GraphUnit, Graph] = WITio.core.wip.transform(GraphTransformation, (1:SizeGraph+1)'); % 25.2.2019 transform_forced would cause NaN if ForceSpectralUnit == '(rel. 1/cm)' due to missing ExcitationWavelength!
    ...
    LengthY = SizeY;
    LengthZ = SizeZ;
    LengthUnit = WITio.core.wip.ArbitraryUnit;
    ...
    SecondaryLengthUnit = WITio.core.wip.ArbitraryUnit;
    ...
    out.XInterpretation = WITio.core.wid.empty;
    ...
    out.YInterpretation = WITio.core.wid.empty;
    ...
    out.ZInterpretation = WITio.core.wid.empty;
    ...
    out.SecondaryXInterpretation = WITio.core.wid.empty;
    ...
    out.SecondaryYInterpretation = WITio.core.wid.empty;
    ...
    out.SecondaryZInterpretation = WITio.core.wid.empty;
end

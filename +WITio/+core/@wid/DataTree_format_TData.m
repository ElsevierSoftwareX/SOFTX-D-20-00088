...
function format = DataTree_format_TData(Version_or_obj),
    ...
    if isa(Version_or_obj, 'WITio.core.wid') || isa(Version_or_obj, 'WITio.core.wip') || isa(Version_or_obj, 'WITio.core.wit'),
        Version = WITio.core.wip.get_Root_Version(Version_or_obj);
    end

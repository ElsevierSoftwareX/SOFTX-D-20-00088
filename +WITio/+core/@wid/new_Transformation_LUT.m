...
function obj = new_Transformation_LUT(O_wit, LUTSize),
    ...
    Tag_Extra = WITio.core.wit('TDLUTTransformation', [ ...
        WITio.core.wit('Version', int32(0)) ...
        WITio.core.wit('LUTSize', int32(LUTSize)) ...
        WITio.core.wit('LUT', double(1:LUTSize)) ...
        WITio.core.wit('LUTIsIncreasing', true) ...
        ]);
    
    Tag_DataClassName = WITio.core.wit('DataClassName 0', 'TDLUTTransformation');

...
% WITio.wid.plot_position_Image_helper.m, WITio.wid.plot_position_Line_helper.m and
% WITio.wid.plot_position_Point_helper.m.
function h_position = plot_position(obj, FigAxNeither, varargin),
    ...
    markImage = @WITio.wid.plot_position_Image_helper;
    ...
    markLine = @WITio.wid.plot_position_Line_helper;
    ...
    markPoint = @WITio.wid.plot_position_Point_helper;
    ...
    B_valid = cellfun(@(x) isa(x, 'WITio.wid'), varargin); % Test if wid

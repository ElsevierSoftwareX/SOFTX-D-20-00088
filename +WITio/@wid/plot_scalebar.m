...
% Default scalebar plotter function 'WITio.wid.plot_scalebar_helper' accepts the
...
function h_scalebar = plot_scalebar(obj, FigAxNeither, varargin),
    ...
    [datas, varargin] = WITio.parse.varargin_dashed_str_datas('markScalebarFun', varargin, -1);
    markScalebar = @WITio.wid.plot_scalebar_helper;

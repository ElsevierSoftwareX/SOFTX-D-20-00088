...
function obj = new_Interpretation_Spectral(O_wit),
    ...
    Tag_Extra = WITio.wit('TDSpectralInterpretation', [ ...
        WITio.wit('Version', int32(0)) ...
        WITio.wit('ExcitationWaveLength', double(NaN)) ...
        ]);
    
    Tag_DataClassName = WITio.wit('DataClassName 0', 'TDSpectralInterpretation');

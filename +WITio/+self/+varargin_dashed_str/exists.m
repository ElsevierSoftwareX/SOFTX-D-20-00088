...
function varargout = exists(varargin),
    if nargout == 1,
        varargout{1} = WITio.self.varargin_dashed_str.exists_and_datas(varargin{:});
    elseif nargout > 1,
        [varargout{1}, ~, varargout{2:nargout}] = WITio.self.varargin_dashed_str.exists_and_datas(varargin{:});
    end
end

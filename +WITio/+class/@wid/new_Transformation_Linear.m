...
function obj = new_Transformation_Linear(O_wit),
    ...
    Tag_Extra = WITio.class.wit('TDLinearTransformation', [ ...
        WITio.class.wit('Version', int32(0)) ...
        WITio.class.wit('ModelOrigin_D', double(0)) ... % (NOT IN ALL LEGACY VERSIONS)
        WITio.class.wit('WorldOrigin_D', double(0)) ... % (NOT IN ALL LEGACY VERSIONS) % 1 for null-transformation in MATLAB
        WITio.class.wit('Scale_D', double(1)) ... % (NOT IN ALL LEGACY VERSIONS)
        WITio.class.wit('ModelOrigin', single(0)) ...
        WITio.class.wit('WorldOrigin', single(0)) ... % 1 for null-transformation in MATLAB
        WITio.class.wit('Scale', single(1)) ...
        ]);
    
    Tag_DataClassName = WITio.class.wit('DataClassName 0', 'TDLinearTransformation');

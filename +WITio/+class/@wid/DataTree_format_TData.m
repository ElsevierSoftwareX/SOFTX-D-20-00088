...
function format = DataTree_format_TData(Version_or_obj),
    ...
    if isa(Version_or_obj, 'WITio.class.wid') || isa(Version_or_obj, 'WITio.class.wip') || isa(Version_or_obj, 'WITio.class.wit'),
        Version = WITio.class.wip.get_Root_Version(Version_or_obj);
    end

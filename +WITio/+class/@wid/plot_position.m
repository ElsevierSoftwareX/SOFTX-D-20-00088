...
function h_position = plot_position(obj, FigAxNeither, varargin),
    ...
    datas = WITio.self.varargin_dashed_str.datas('markImageFun', varargin, -1);
    ...
    datas = WITio.self.varargin_dashed_str.datas('markLineFun', varargin, -1);
    ...
    datas = WITio.self.varargin_dashed_str.datas('markPointFun', varargin, -1);

...
function obj = new_Bitmap(O_wit),
    ...
    Tag_DataClassName = WITio.class.wit('DataClassName 0', 'TDBitmap');
    ...
    if isempty(Version) || Version == 7,
        Tag_TDBitmap = WITio.class.wit('TDBitmap', [ ...
            ...
            WITio.class.wit('BitmapData', [WITio.class.wit('Dimension', int32(2)) WITio.class.wit('DataType', int32(10)) WITio.class.wit('Ranges', int32([0 0])) WITio.class.wit('Data', uint8.empty)]) ... % Empty cannot be opened in WITec Project 2.10.3.3
            ]);
    ...
    elseif Version >= 0 && Version <= 5, % Legacy versions
        Tag_TDStream = WITio.class.wit('TDStream', [ ...
            ...
            WITio.class.wit('StreamData', uint8.empty) ... % Empty cannot be opened in WITec Project 2.10.3.3
            ]);
        Tag_TDBitmap = WITio.class.wit('TDBitmap', [ ...
            WITio.class.wit('Version', int32(0)) ...
            WITio.class.wit('SpaceTransformationID', int32(0)) ...

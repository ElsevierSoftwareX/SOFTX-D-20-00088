...
function out = wid_Info_get(obj),
    ...
    SpaceTransformation = WITio.class.wid.empty;
    SecondaryTransformation = WITio.class.wid.empty; % v7 (only known case: Time<TDGraph, where SpaceTransformation and SecondaryTransformation are related to time (a vector) and space (a single point) in WITec Project FIVE, respectively.)
    GraphTransformation = WITio.class.wid.empty;
    GraphInterpretation = WITio.class.wid.empty;
    DataInterpretation = WITio.class.wid.empty;
    ...
    [GraphUnit, Graph] = WITio.class.wip.transform(GraphTransformation, (1:SizeGraph+1)'); % 25.2.2019 transform_forced would cause NaN if ForceSpectralUnit == '(rel. 1/cm)' due to missing ExcitationWavelength!
    ...
    LengthY = SizeY;
    LengthZ = SizeZ;
    LengthUnit = WITio.class.wip.ArbitraryUnit;
    ...
    SecondaryLengthUnit = WITio.class.wip.ArbitraryUnit;
    ...
    out.XInterpretation = WITio.class.wid.empty;
    ...
    out.YInterpretation = WITio.class.wid.empty;
    ...
    out.ZInterpretation = WITio.class.wid.empty;
    ...
    out.SecondaryXInterpretation = WITio.class.wid.empty;
    ...
    out.SecondaryYInterpretation = WITio.class.wid.empty;
    ...
    out.SecondaryZInterpretation = WITio.class.wid.empty;
end

...
function obj = new_Interpretation_Spectral(O_wit),
    ...
    Tag_Extra = WITio.class.wit('TDSpectralInterpretation', [ ...
        WITio.class.wit('Version', int32(0)) ...
        WITio.class.wit('ExcitationWaveLength', double(NaN)) ...
        ]);
    
    Tag_DataClassName = WITio.class.wit('DataClassName 0', 'TDSpectralInterpretation');

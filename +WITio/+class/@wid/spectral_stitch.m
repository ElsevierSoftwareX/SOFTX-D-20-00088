...
function [new_obj, Graph, Data, W, D] = spectral_stitch(obj, varargin),
    ...
    isdebug = WITio.self.varargin_dashed_str.exists('debug', varargin);
    ...
    [Graph, Data, W, D] = WITio.class.wid.spectral_stitch_helper(Graphs_nm, Datas, isdebug);
    ...
    if AutoCreateObj,
        ...
        new_SpectralT = WITio.class.wid.new_Transformation_LUT(obj.Tag.Root, numel(Graph)); % This does not add newly created object to Project yet!

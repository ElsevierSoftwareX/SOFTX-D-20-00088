...
%-------------------------------------------------------------------------%
% Plottable objects
figure; O_Bitmap.plot(); WITio.tbx.ifnodesktop(); % TDBitmap with sidebar
figure; O_ImageScan.plot(); WITio.tbx.ifnodesktop(); % TDGraph with sidebar
figure; O_Mask.plot('-nosidebar'); WITio.tbx.ifnodesktop(); % TDImage WITHOUT SIDEBAR
figure; O_Text.plot(); WITio.tbx.ifnodesktop(); % TDText with sidebar'

% Non-plottable objects like TDSpaceTransformation
figure; O_Bitmap.Info.XTransformation.plot(); WITio.tbx.ifnodesktop(); % TDBitmap's TDSpaceTransformation with sidebar

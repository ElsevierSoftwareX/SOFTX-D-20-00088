...
wip_AutoDestroyViewers = WITio.tbx.pref.get('wip_AutoDestroyViewers', true);
wip_AutoDestroyDuplicateTransformations = WITio.tbx.pref.get('wip_AutoDestroyDuplicateTransformations', true);
wip_AutoNanInvalid = WITio.tbx.pref.get('wip_AutoNanInvalid', true);
...
WITio.tbx.pref.set('wip_AutoDestroyViewers', false);
WITio.tbx.pref.set('wip_AutoDestroyDuplicateTransformations', false);
WITio.tbx.pref.set('wip_AutoNanInvalid', false);

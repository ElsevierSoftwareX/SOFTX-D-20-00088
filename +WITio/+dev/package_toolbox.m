...
function package_toolbox(),
    ...
    WITio_description = {WITio.fun.indep.mystrjoin({...
        ...
        'When combined with the WITec software''s Autosaving feature, they can together even achieve a powerful real-time during-measurement task automation for industrial applications.', ...
    ...
    WITio_exclude_filters = {'.git/*', '.gitlab/*', '*.sh'};

...
% to the underlying writing function, i.e. WITio.compress.m. See its
...
function write(obj, varargin),
    ...
    function OnWriteCompress_helper(obj, File),
        WITio.compress(File, File_uncompressed, obj.bwrite(), '-ProgressBar', Params{:}); % Compress binary as *.zip/*.zst file
    end
end

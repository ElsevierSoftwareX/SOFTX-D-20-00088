...
function out = wid_Info_get(obj),
    ...
    SpaceTransformation = WITio.obj.wid.empty;
    SecondaryTransformation = WITio.obj.wid.empty; % v7 (only known case: Time<TDGraph, where SpaceTransformation and SecondaryTransformation are related to time (a vector) and space (a single point) in WITec Project FIVE, respectively.)
    GraphTransformation = WITio.obj.wid.empty;
    GraphInterpretation = WITio.obj.wid.empty;
    DataInterpretation = WITio.obj.wid.empty;
    ...
    [GraphUnit, Graph] = WITio.obj.wip.transform(GraphTransformation, (1:SizeGraph+1)'); % 25.2.2019 transform_forced would cause NaN if ForceSpectralUnit == '(rel. 1/cm)' due to missing ExcitationWavelength!
    ...
    LengthY = SizeY;
    LengthZ = SizeZ;
    LengthUnit = WITio.obj.wip.ArbitraryUnit;
    ...
    SecondaryLengthUnit = WITio.obj.wip.ArbitraryUnit;
    ...
    out.XInterpretation = WITio.obj.wid.empty;
    ...
    out.YInterpretation = WITio.obj.wid.empty;
    ...
    out.ZInterpretation = WITio.obj.wid.empty;
    ...
    out.SecondaryXInterpretation = WITio.obj.wid.empty;
    ...
    out.SecondaryYInterpretation = WITio.obj.wid.empty;
    ...
    out.SecondaryZInterpretation = WITio.obj.wid.empty;
end

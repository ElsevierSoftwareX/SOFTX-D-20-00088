...
function [new_obj, I, Pos, Fwhm, I0, R2, Residuals, Fit] = filter_lorentzian(obj, varargin),
    ...
    str_fun = {'I<Lorentz', 'Pos<Lorentz', 'Fwhm<Lorentz', 'I0<Lorentz', 'R^2<Lorentz', 'Residuals<Lorentz', 'Fit<Lorentz'};
    [new_obj, I, Pos, Fwhm, I0, R2, Residuals, Fit] = obj.filter_fun(@fun, str_fun, varargin{:});
    
    function [F, I_new] = fun(I, X, dim),
        P0 = WITio.fun.fit.fit_lineshape_automatic_guess(X, I, dim);
        [P, R2, SSres, Y_fit] = WITio.fun.fit.fit_lineshape_lorentzian(X, I, P0, dim, opts{:});

...
function obj = new_Interpretation_Spectral(O_wit),
    ...
    Tag_Extra = WITio.obj.wit('TDSpectralInterpretation', [ ...
        WITio.obj.wit('Version', int32(0)) ...
        WITio.obj.wit('ExcitationWaveLength', double(NaN)) ...
        ]);
    
    Tag_DataClassName = WITio.obj.wit('DataClassName 0', 'TDSpectralInterpretation');

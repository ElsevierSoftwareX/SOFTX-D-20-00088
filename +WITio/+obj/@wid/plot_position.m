...
% WITio.obj.wid.plot_position_Image_helper.m, WITio.obj.wid.plot_position_Line_helper.m and
% WITio.obj.wid.plot_position_Point_helper.m.
function h_position = plot_position(obj, FigAxNeither, varargin),
    ...
    markImage = @WITio.obj.wid.plot_position_Image_helper;
    ...
    markLine = @WITio.obj.wid.plot_position_Line_helper;
    ...
    markPoint = @WITio.obj.wid.plot_position_Point_helper;
    ...
    B_valid = cellfun(@(x) isa(x, 'WITio.obj.wid'), varargin); % Test if wid

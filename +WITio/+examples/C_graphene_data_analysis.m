...
h = WITio.core.msgbox({'{\bf\fontsize{12}\color{magenta}EXAMPLE CASE C:}' ...
...
if ishandle(h), figure(h); uiwait(h); end % Wait for WITio.core.msgbox to be closed before continuing.
%-------------------------------------------------------------------------%
...
[O_wid, O_wip, O_wid_HtmlNames] = WITio.read(file, '-all', '-SpectralUnit', 'rel. 1/cm');
...
%-------------------------------------------------------------------------%
h = WITio.core.msgbox({'{\bf\fontsize{12}{\color{magenta}(C i.)} Recalibrating the Rayleigh-peak ' ...
'to zero position:}' ...
'' ...
...
%-------------------------------------------------------------------------%
h = WITio.core.msgbox({'{\bf\fontsize{12}{\color{magenta}(C ii.)} Lorentzians are fitted to the D-, ' ...
'G- and 2D-peaks.}' ...
'' ...
...
%-------------------------------------------------------------------------%
h = WITio.core.msgbox({'{\bf\fontsize{12}{\color{magenta}(C iii.)} Clean-up of the fitted data:}' ...
'' ...
...
[bw_D_invalid, O_D(1).Data, O_D(2).Data, O_D(3).Data, O_D(4).Data] = ...
    WITio.fun.data_true_and_nan_collective_hole_reduction(O_D(5).Data<R_2_threshold, ...
...
[bw_G_invalid, O_G(1).Data, O_G(2).Data, O_G(3).Data, O_G(4).Data] = ...
    WITio.fun.data_true_and_nan_collective_hole_reduction(O_G(5).Data<R_2_threshold, ...
...
[bw_2D_invalid, O_2D(1).Data, O_2D(2).Data, O_2D(3).Data, O_2D(4).Data] = ...
    WITio.fun.data_true_and_nan_collective_hole_reduction(O_2D(5).Data<R_2_threshold, ...
...
%-------------------------------------------------------------------------%
h = WITio.core.msgbox({'{\bf\fontsize{12}{\color{magenta}(C iv.)} Histograms of the previously cleaned intensity ratios, ' ...

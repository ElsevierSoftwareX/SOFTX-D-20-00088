...
h = WITio.misc.msgbox({'{\bf\fontsize{12}\color{magenta}EXAMPLE CASE A1:}' ...
...
%-------------------------------------------------------------------------%
WITio.misc.msgbox({'{\bf\fontsize{12}{\color{magenta}(A1 i.)} Load and browse file contents in a ' ...
'GUI by executing:}' ...
'' ...
...
%-------------------------------------------------------------------------%
h = WITio.misc.msgbox({'{\bf\fontsize{12}{\color{magenta}(A1 ii.)} OR, load all file contents without GUI by executing:}' ...
'' ...

...
h = WITio.self.msgbox({'{\bf\fontsize{12}\color{magenta}EXAMPLE CASE A1:}' ...
...
%-------------------------------------------------------------------------%
WITio.self.msgbox({'{\bf\fontsize{12}{\color{magenta}(A1 i.)} Load and browse file contents in a ' ...
'GUI by executing:}' ...
'' ...
...
%-------------------------------------------------------------------------%
h = WITio.self.msgbox({'{\bf\fontsize{12}{\color{magenta}(A1 ii.)} OR, load all file contents without GUI by executing:}' ...
'' ...

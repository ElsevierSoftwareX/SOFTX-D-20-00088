...
%     cHeight = [cumsum(Height(2:end), 'reverse') 0];
    ...
    function update(varargin),
        ...
        set(0, 'DefaultFigureColormap', WITio.lib.perceptually_uniform_colormap(C_options{currentValue})); % Set new default! Backward compatible!
        set(Fig, 'Colormap', 'default'); % Reset to new default! Backward compatible!
%         set(Fig, 'Colormap', WITio.lib.perceptually_uniform_colormap(C_options{currentValue}));
%         colormap(Ax, WITio.lib.perceptually_uniform_colormap(C_options{currentValue}));
    end
end

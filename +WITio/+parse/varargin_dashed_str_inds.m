...
function varargout = varargin_dashed_str_inds(varargin),
    if nargout == 1,
        varargout{1} = WITio.parse.varargin_dashed_str_inds_and_datas(varargin{:});
    elseif nargout > 1,
        [varargout{1}, ~, varargout{2:nargout}] = WITio.parse.varargin_dashed_str_inds_and_datas(varargin{:});
    end
end

...
function varargout = inds(varargin),
    if nargout == 1,
        varargout{1} = WITio.fun.varargin_dashed_str.inds_and_datas(varargin{:});
    elseif nargout > 1,
        [varargout{1}, ~, varargout{2:nargout}] = WITio.fun.varargin_dashed_str.inds_and_datas(varargin{:});
    end
end

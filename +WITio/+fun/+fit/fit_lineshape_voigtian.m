...
function [P, R2, SSres, Y_fit, R2_total, SSres_total] = fit_lineshape_voigtian(x, Y, P0, dim, varargin),
    ...
    datas = WITio.misc.varargin_dashed_str.datas('Fwhm_G', varargin, -1);
    if numel(datas) > 0,
        Fwhm_G = datas{1};
        ...
        varargin = WITio.misc.varargin_dashed_str.removed('Fwhm_G', varargin); % Remove this option from varargin!

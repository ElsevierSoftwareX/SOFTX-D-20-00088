...
new_TDGraph_TSpectral = wid.new_Transformation_Spectral(O_wit);
...
O_wip.add_Data(new_TDGraph, new_TDGraph_TSpectral, new_TDGraph_ISpectral); % Make new objects visible in Project-object
...
for ii = 1:7,
    ...
    LUTT = wid.new_Transformation_LUT(O_wit);
...
O_wip.manager('-all', '-closepreview');

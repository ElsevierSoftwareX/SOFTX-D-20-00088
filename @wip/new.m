...
function C_wit = new(Version)
    ...
    if nargin == 0 || isempty(Version) || Version == 7, % Default: latest version
        ...
        C_wit.Magic = 'WIT_PR06'; % Enforce the correct Magic string!
    elseif Version == 6,
        C_wit = wit('WITec Project', [ ...
            wit('Version', int32(6)) ...
            wit('SystemInformation', [wit('LastApplicationSessionIDs', wit()) wit('ServiceID', '') wit('LicenseID', '') wit('ApplicationVersions', wit(['MATLAB ' version]))]) ...
    ...
    elseif Version == 5,
        ...
        C_wit.Magic = 'WIT_PRCT'; % Enforce the correct Magic string!

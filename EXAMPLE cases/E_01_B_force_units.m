...
h = wit_io_msgbox({'{\bf\fontsize{12}\color{magenta}EXAMPLE CASE 1 B:}' ...
...
%-------------------------------------------------------------------------%
h = wit_io_msgbox({'{\bf\fontsize{12}{\color{magenta}(E1B)} The imported content units (DataUnit, SpaceUnit, SpectralUnit and TimeUnit) may be modified upon loading:}' ...
    '' ...
    '{\bf\fontsize{12}{\color{magenta}(E1B i.)} by adding parameter pairs to wit.io.wip.read as below:}' ...
    '' ...
    '{\bf\fontname{Courier}[...] = wit.io.wip.read(..., ''-DataUnit'', ''Counts'', ''-SpaceUnit'', ''um'', ...' ...
    '''-SpectralUnit'', ''nm'', ''-TimeUnit'', ''s'');}' ...
    '' ...
    '{\bf\fontsize{12}{\color{magenta}(E1B ii.)} by specifying the units in the bottom of the opened Project Manager GUI.}' ...
    '' ...
    '{\bf\fontsize{12}{\color{magenta}(E1B iii.)} by modifying O\_wip-object ForceDataUnit, ForceSpaceUnit, ForceSpectralUnit and ForceTimeUnit:}' ...
    '' ...
    ...
    '' ...
    '{\bf\fontsize{12}{\color{magenta}(E1B iv.)} temporarily using wit.io.wip.interpret (or easier wid-class interpret\_X, interpret\_Y, interpret\_Z, interpret\_Graph member-functions).}' ...
    '' ...
...
%-------------------------------------------------------------------------%
% !!! (E1B i.) Enforce units via wit.io.wip.read extra parameters:
...
% !!! (E1B iv.) Temporarily alter units via wit.io.wip.interpret:

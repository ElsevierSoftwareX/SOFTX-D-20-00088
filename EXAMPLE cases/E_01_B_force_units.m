...
h = wit_io_msgbox({'{\bf\fontsize{12}{\color{magenta}(E1B)} The imported content units (DataUnit, SpaceUnit, SpectralUnit and TimeUnit) may be modified upon loading:}' ...
    '' ...
    '{\bf\fontsize{12}{\color{magenta}(E1B i.)} by adding parameter pairs to wip.read as below:}' ...
    '' ...
    '{\bf\fontname{Courier}[...] = wip.read(..., ''-DataUnit'', ''Counts'', ''-SpaceUnit'', ''um'', ...' ...
    ...
    '' ...
    '{\bf\fontsize{12}{\color{magenta}(E1B iv.)} temporarily using wip.interpret (or easier wid-class interpret\_X, interpret\_Y, interpret\_Z, interpret\_Graph member-functions).}' ...
    '' ...

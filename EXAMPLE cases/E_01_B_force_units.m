...
h = helpdlg({'!!! (E1B) The imported content units (DataUnit, SpaceUnit, SpectralUnit and TimeUnit) may be modified upon loading:' ...
    ...
    '' ...
    '!!! (E1B iii.) by modifying C_wip-object ForceDataUnit, ForceSpaceUnit, ForceSpectralUnit and ForceTimeUnit:' ...
...
C_wip.ForceSpaceUnit = 'Micrometers (µm)'; % Set SpaceUnit to µm by its full name (seen from full list of wip.FullStandardUnits)
